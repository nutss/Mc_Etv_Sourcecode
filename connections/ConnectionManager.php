...
class ConnectionManager extends ConnectionManager_Base
{
	...
	protected function _setConnectionsData()
	{
		...
		$data["connName"] = "mc at 192.168.200.1";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;192.168.200.1;mc.classicscan.co.th;qapmoc;;mc;;3"; //currently unused

		$this->_connectionsIdByName["mc at 192.168.200.1"] = "mc_at_192_168_1_111";

		$data["connInfo"] = array();
		$data["ODBCUID"] = "mc.classicscan.co.th";
		$data["ODBCPWD"] = "qapmoc";
		$data["leftWrap"] = "`";
		$data["rightWrap"] = "`";
		...
		$data["connInfo"][0] = "192.168.200.1";
		$data["connInfo"][1] = "mc.classicscan.co.th";
		$data["connInfo"][2] = "qapmoc";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "mc";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "3"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=192.168.200.1;Uid=mc.classicscan.co.th;Pwd=qapmoc;Database=mc;OPTION=3";
		// encription set
