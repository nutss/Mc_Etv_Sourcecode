...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "playlistMain" ] = array( "url" => "playlistmain", "type" => 0 );
	$projectEntitiesReverse[ "playlistmain" ] = "playlistMain";
	$projectEntities[ "playlistSub" ] = array( "url" => "playlistsub", "type" => 0 );
	$projectEntitiesReverse[ "playlistsub" ] = "playlistSub";
	$projectEntities[ "mediaInfo" ] = array( "url" => "mediainfo", "type" => 0 );
	$projectEntitiesReverse[ "mediainfo" ] = "mediaInfo";
	$projectEntities[ "staffUsers" ] = array( "url" => "staffusers", "type" => 0 );
	$projectEntitiesReverse[ "staffusers" ] = "staffUsers";
	$projectEntities[ "FileAdmin" ] = array( "url" => "fileadmin", "type" => 1 );
	$projectEntitiesReverse[ "fileadmin" ] = "FileAdmin";
	$projectEntities[ "censorPass" ] = array( "url" => "censorpass", "type" => 1 );
	$projectEntitiesReverse[ "censorpass" ] = "censorPass";
	$projectEntities[ "censorReject" ] = array( "url" => "censorreject", "type" => 1 );
	$projectEntitiesReverse[ "censorreject" ] = "censorReject";
	$projectEntities[ "teacher" ] = array( "url" => "teacher", "type" => 0 );
	$projectEntitiesReverse[ "teacher" ] = "teacher";
	$projectEntities[ "subject" ] = array( "url" => "subject", "type" => 0 );
	$projectEntitiesReverse[ "subject" ] = "subject";
	$projectEntities[ "educationLevel" ] = array( "url" => "educationlevel", "type" => 0 );
	$projectEntitiesReverse[ "educationlevel" ] = "educationLevel";
	...
	$projectEntities[ "mc_audit" ] = array( "url" => "mc_audit", "type" => 0 );
	$projectEntitiesReverse[ "mc_audit" ] = "mc_audit";
	$projectEntities[ "MediaInfo Report" ] = array( "url" => "mediainfo_report", "type" => 2 );
	$projectEntitiesReverse[ "mediainfo_report" ] = "MediaInfo Report";
	$projectEntities[ "Censor Report" ] = array( "url" => "censor_report", "type" => 2 );
	$projectEntitiesReverse[ "censor_report" ] = "Censor Report";
	$projectEntities[ "censorUncensor" ] = array( "url" => "censoruncensor", "type" => 1 );
	$projectEntitiesReverse[ "censoruncensor" ] = "censorUncensor";
	$projectEntities[ "playlist Report" ] = array( "url" => "playlist_report", "type" => 2 );
	$projectEntitiesReverse[ "playlist_report" ] = "playlist Report";
	$projectEntities[ "IngestInfo" ] = array( "url" => "ingestinfo", "type" => 1 );
	$projectEntitiesReverse[ "ingestinfo" ] = "IngestInfo";
	$projectEntities[ "downloadInfo" ] = array( "url" => "downloadinfo", "type" => 1 );
