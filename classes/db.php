...
class DB
{
	...
	protected static function _fillTablesList( $conn )
	{
		...
		if( "mc_at_192_168_1_111" == $conn->connId )
		{
			...
			$dalTables[$conn->connId][] = array("name" => "staffUsers", "varname" => "mc_at_192_168_1_111__staffUsers", "altvarname" => "staffUsers", "connId" => "mc_at_192_168_1_111", "schema" => "", "connName" => "mc at 192.168.200.1");
			$dalTables[$conn->connId][] = array("name" => "subject", "varname" => "mc_at_192_168_1_111__subject", "altvarname" => "subject", "connId" => "mc_at_192_168_1_111", "schema" => "", "connName" => "mc at 192.168.200.1");
			$dalTables[$conn->connId][] = array("name" => "teacher", "varname" => "mc_at_192_168_1_111__teacher", "altvarname" => "teacher", "connId" => "mc_at_192_168_1_111", "schema" => "", "connName" => "mc at 192.168.200.1");
		}
	}
