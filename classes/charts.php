...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("playlistMain" == $this->chrt_array['tables'][0])
			return true;
		if("playlistSub" == $this->chrt_array['tables'][0])
			return true;
		...
		if("mediaInfo" == $this->chrt_array['tables'][0])
			return true;
		if("teacher" == $this->chrt_array['tables'][0])
			return true;
		if("subject" == $this->chrt_array['tables'][0])
			return true;
		if("educationLevel" == $this->chrt_array['tables'][0])
			return true;
		if("mc_ugrights" == $this->chrt_array['tables'][0])
			return true;
		if("staffUsers" == $this->chrt_array['tables'][0])
			return true;
		if("staffUsers" == $this->chrt_array['tables'][0])
			return true;
		if("mc_audit" == $this->chrt_array['tables'][0])
			return true;
		if("mediaInfo" == $this->chrt_array['tables'][0])
			return true;
		if("mediaInfo" == $this->chrt_array['tables'][0])
