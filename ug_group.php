...
$nonAdminTablesArr[] = "playlistMain";
$nonAdminTablesArr[] = "playlistSub";
$nonAdminTablesArr[] = "mediaInfo";
$nonAdminTablesArr[] = "staffUsers";
$nonAdminTablesArr[] = "FileAdmin";
$nonAdminTablesArr[] = "censorPass";
$nonAdminTablesArr[] = "censorReject";
$nonAdminTablesArr[] = "teacher";
$nonAdminTablesArr[] = "subject";
$nonAdminTablesArr[] = "educationLevel";
$nonAdminTablesArr[] = "mc_audit";
$nonAdminTablesArr[] = "MediaInfo Report";
$nonAdminTablesArr[] = "Censor Report";
$nonAdminTablesArr[] = "censorUncensor";
$nonAdminTablesArr[] = "playlist Report";
...
$wGroupTableName = $ug_connection->addTableWrappers( "mc_uggroups" );
...
switch(postvalue("a"))
{
	...
	case "del":
		...
		$sql = "delete from ". $ug_connection->addTableWrappers( "mc_ugrights" ) 
	...
	case 'saveRights':
		...
		{	
			...
			$wRightsTableName = $ug_connection->addTableWrappers( "mc_ugrights" );
