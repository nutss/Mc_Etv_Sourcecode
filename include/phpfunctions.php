...
$value="<span style='color: " . $color . "'>" .$value . "</span>";;
		return $value;
				...
				if($table=="FileAdmin" && $field=="fileStatus")
	{
		if ($value == "PROCESS") {  
    $color="red";  
} elseif ($value == "READY") {  
...
$value="<span style='color: " . $color . "'>" .$value . "</span>";;
		return $value;
				...
				if($table=="censorPass" && $field=="fileStatus")
	{
		if ($value == "PROCESS") {  
    $color="red";  
} elseif ($value == "READY") {  
...
$value="<span style='color: " . $color . "'>" .$value . "</span>";;
		return $value;
				...
				if($table=="censorReject" && $field=="fileStatus")
	{
		if ($value == "PROCESS") {  
    $color="red";  
} elseif ($value == "READY") {  
...
$value="<span style='color: " . $color . "'>" .$value . "</span>";;
		return $value;
				...
				if($table=="censorUncensor" && $field=="fileStatus")
	{
		if ($value == "PROCESS") {  
    $color="red";  
} elseif ($value == "READY") {  
...
$value="<span style='color: " . $color . "'>" .$value . "</span>";;
		return $value;
				...
				if($table=="IngestInfo" && $field=="fileStatus")
	{
		if ($value == "PROCESS") {  
    $color="red";  
} elseif ($value == "READY") {  
...
$value="<span style='color: " . $color . "'>" .$value . "</span>";;
		return $value;
				...
				if($table=="downloadInfo" && $field=="fileStatus")
	{
		if ($value == "PROCESS") {  
    $color="red";  
} elseif ($value == "READY") {  
...
$value="<span style='color: " . $color . "'>" .$value . "</span>";;
		return $value;
				...
				if($table=="deleteInfo" && $field=="fileStatus")
	{
		if ($value == "PROCESS") {  
    $color="red";  
} elseif ($value == "READY") {  
...
{
	$value = "";
				if($table=="playlistSub" && $field=="fileRaw")
	{
		$value = $data["fileName"];;
		return $value;
	}
				if($table=="mediaInfo" && $field=="fileRaw")
	{
		;
		return $value;
	}
				if($table=="FileAdmin" && $field=="fileRaw")
	{
		;
		return $value;
	}
				if($table=="censorPass" && $field=="fileRaw")
	{
		;
		return $value;
	}
				if($table=="censorReject" && $field=="fileRaw")
	{
		;
		return $value;
	}
				if($table=="MediaInfo Report" && $field=="fileRaw")
	{
		;
		return $value;
	}
				if($table=="Censor Report" && $field=="fileRaw")
	{
		;
		return $value;
	}
				if($table=="censorUncensor" && $field=="fileRaw")
	{
		;
		return $value;
	}
				if($table=="IngestInfo" && $field=="fileRaw")
	{
		;
		return $value;
	}
				if($table=="downloadInfo" && $field=="fileRaw")
	{
		;
		return $value;
	}
				if($table=="deleteInfo" && $field=="fileRaw")
	{
		;
		return $value;
	}
...
function GetDefaultValue($field, $ptype, $table="")
{
	...
	if(!$table)
		$table=$strTableName;
				if($table=="playlistMain" && $field=="entryTime")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="playlistMain" && $field=="entryUserName")
	{
		return $_SESSION["UserName"];
	}
				if($table=="playlistMain" && $field=="playlistOnairDate")
	{
		return strftime("%Y-%m-%d");
	}
				if($table=="playlistMain" && $field=="playlistOnairTime1")
	{
		return strftime("%H:%M:%S");
	}
				if($table=="playlistMain" && $field=="palylistOnairTime2")
	{
		return strftime("%H:%M:%S");
	}
				if($table=="playlistSub" && $field=="entryUserName")
	{
		return $_SESSION["UserName"];
	}
				if($table=="playlistSub" && $field=="entryTime")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="mediaInfo" && $field=="censorStatus")
	{
		return "UNCENSOR";
	}
				if($table=="mediaInfo" && $field=="entryUserName")
	{
		return $_SESSION["UserName"];
	}
				if($table=="mediaInfo" && $field=="entryTime")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				...
				if($table=="FileAdmin" && $field=="censorApproveTime")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
				...
				if($table=="FileAdmin" && $field=="censorUsername")
	{
		return $_SESSION["UserName"];
	}
				if($table=="FileAdmin" && $field=="entryUserName")
	{
		return $_SESSION["UserName"];
	}
				if($table=="FileAdmin" && $field=="entryTime")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="censorPass" && $field=="censorApproveTime")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="censorPass" && $field=="censorUsername")
	{
		return $_SESSION["UserName"];
	}
				if($table=="censorPass" && $field=="entryUserName")
	{
		return $_SESSION["UserName"];
	}
				if($table=="censorPass" && $field=="entryTime")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="censorReject" && $field=="censorApproveTime")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="censorReject" && $field=="censorUsername")
	{
		return $_SESSION["UserName"];
	}
				if($table=="censorReject" && $field=="entryUserName")
	{
		return $_SESSION["UserName"];
	}
				if($table=="censorReject" && $field=="entryTime")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				...
				if($table=="subject" && $field=="entryTime")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
				...
				if($table=="subject" && $field=="entryUserName")
	{
		return $_SESSION["UserName"];
	}
				if($table=="educationLevel" && $field=="entryTime")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
				...
				if($table=="educationLevel" && $field=="entryUserName")
	{
		return $_SESSION["UserName"];
	}
				if($table=="admin_members" && $field=="entryTime")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
				...
				if($table=="admin_members" && $field=="entryUserName")
	{
		return $_SESSION["UserName"];
	}
				...
				if($table=="MediaInfo Report" && $field=="entryUserName")
	{
		return $_SESSION["UserName"];
				...
				if($table=="MediaInfo Report" && $field=="entryTime")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				...
				if($table=="censorUncensor" && $field=="censorApproveTime")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
				...
				if($table=="censorUncensor" && $field=="censorUsername")
	{
		return $_SESSION["UserName"];
	}
				if($table=="censorUncensor" && $field=="entryUserName")
	{
		return $_SESSION["UserName"];
	}
				if($table=="censorUncensor" && $field=="entryTime")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="IngestInfo" && $field=="filedate")
	{
		return strftime("%Y-%m-%d");
	}
				if($table=="IngestInfo" && $field=="censorStatus")
	{
		return "UNCENSOR";
	}
				if($table=="IngestInfo" && $field=="entryUserName")
	{
		return $_SESSION["UserName"];
	}
				if($table=="IngestInfo" && $field=="entryTime")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="downloadInfo" && $field=="filedate")
	{
		return strftime("%Y-%m-%d");
	}
				if($table=="downloadInfo" && $field=="censorStatus")
	{
		return "UNCENSOR";
	}
				if($table=="downloadInfo" && $field=="entryUserName")
	{
		return $_SESSION["UserName"];
	}
				if($table=="downloadInfo" && $field=="entryTime")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="deleteInfo" && $field=="filedate")
	{
		return strftime("%Y-%m-%d");
	}
				if($table=="deleteInfo" && $field=="censorStatus")
	{
		return "UNCENSOR";
	}
				if($table=="deleteInfo" && $field=="entryUserName")
	{
		return $_SESSION["UserName"];
	}
