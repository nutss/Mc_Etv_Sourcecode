...
if(mlang_getcurrentlang()=="Thai")
{
	...
	$fieldLabelscensor_report["Thai"]["fileNo"] = "ID (หมายเลขไฟล์)";
	...
	$fieldLabelscensor_report["Thai"]["censorStatus"] = "CODE";
