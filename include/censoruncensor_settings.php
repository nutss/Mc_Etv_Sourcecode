...
if(mlang_getcurrentlang()=="English")
{
	...
	$pageTitlescensoruncensor["English"]["edit"] = "Censor Uncensor, Edit [{%fileNo}]";
	$pageTitlescensoruncensor["English"]["view"] = "Censor Uncensor [{%fileNo}]";
...
if(mlang_getcurrentlang()=="Thai")
{
	...
	$pageTitlescensoruncensor["Thai"]["edit"] = "เซ็นเซอร์ (รอตรวจสอบ), แก้ไข [{%fileNo}]";
	$pageTitlescensoruncensor["Thai"]["view"] = "เซ็นเซอร์ (รอตรวจสอบ) [{%fileNo}]";
