...
$tdatasubject[".sqlHead"] = "SELECT id,  	subjectCode,  	subjectName,  	subjectDesc,  	entryUserName,  	entryTime";
...
$proto0["m_strFieldList"] = "id,  	subjectCode,  	subjectName,  	subjectDesc,  	entryUserName,  	entryTime";
